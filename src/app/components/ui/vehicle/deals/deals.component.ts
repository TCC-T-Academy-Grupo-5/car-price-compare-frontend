...
import {DealComponent} from '@components/ui/vehicle/deals/deal/deal.component';
...
@Component({
  selector: 'tcc-deals',
  standalone: true,
  imports: [CommonModule, DealComponent, MatProgressSpinner, TranslateModule, SpinnerComponent],
